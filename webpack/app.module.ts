...
const routes: Routes = [
  {path: 'rooms', pathMatch: 'full', canActivate: [StepGuard], component: RoomListComponent},
  {path: 'room',  pathMatch: 'full', canActivate: [StepGuard], component: RoomComponent},
  {path: 'game',  pathMatch: 'full', canActivate: [StepGuard], component: GameComponent},
  {path: 'login', pathMatch: 'full', canActivate: [StepGuard], component: LoginFormComponent},
